//$HeadURL: svn+ssh://rbezema@svn.wald.intevation.org/deegree/base/branches/2.3_testing/src/org/deegree/datatypes/QualifiedName.java $
/*----------------------------------------------------------------------------
...
public class QualifiedName implements Serializable {
     ...
     * @deprecated use
     * @see #getFormattedString() or
     * @see #getPrefixedName() instead
     */
    @Deprecated
